...
class script(object):
    START_TXT = """<b><blockquote>Hᴇʟʟᴏ {}, ᴍʏ ɴᴀᴍᴇ <a href=https://t.me/{}>{}</a></blockquote></b>"""
...
‣ ᴍʏ ʙᴇsᴛ ғʀɪᴇɴᴅ : <a>ʏᴏᴜ</a> 
‣ ғᴏʀᴋᴇᴅ ғʀᴏᴍ : <a>ᴛᴇᴄʜ ᴠᴊ</a> 
...
my features Stay here new features coming soon...  
 <b>✯ Maintained by : <a>☢ Unknown ☢</a></b>
  
 <b>✯ Join here : <a https://t.me/+exlB9JM0tyc2NzI1>☢Join my updates☢</a></b> 
...
ஏய் <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 படி 1: இந்த FILE-SEARCH-BOT போட் உங்கள் குழுவை நிர்வாகியாக்குங்கள்
...
Hey <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 Step 1: Administer this FILE-SEARCH-BOT bot to your group
...
హే <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 దశ 1: ఈ FILE-SEARCH-BOT బాట్‌ని మీ సమూహానికి నిర్వహించండి
...
अरे <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 चरण 1: इस FILE-SEARCH-BOT को अपने समूह में प्रशासित करें
...
ഹേയ് <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 ഘട്ടം 1: ഈ FILE-SEARCH-BOT ബോട്ട് നിങ്ങളുടെ ഗ്രൂപ്പിലേക്ക് നൽകുക
...
നിങ്ങളുടെ ടീം വീഡിയോ ശേഖരണവും പരിശീലിപ്പിക്കും..."""
 ...
 مرحلہ 1: اپنے گروپ میں اس FILE-SEARCH-BOT بوٹ کا انتظام کریں۔
...
અરે <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 પગલું 1: તમારા જૂથમાં આ FILE-SEARCH-BOT બોટનું સંચાલન કરો
...
ಹೇ {message.from_user.mention}
 ...
 ಹಂತ 1: ಈ FILE-SEARCH-BOT ಅನ್ನು ನಿಮ್ಮ ಗುಂಪಿಗೆ ನಿರ್ವಹಿಸಿ
...
আরে <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 ধাপ 1: আপনার গ্রুপে এই FILE-SEARCH-BOT বট পরিচালনা করুন
